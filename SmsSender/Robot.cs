...
namespace SmsSender
{
    public sealed class Robot
    {
        ...
        public void PushRequest(SmsRequest request)
        {
            ...
            File.AppendAllText("WriteLines.txt", DateTime.Now.ToString("HH:mm:ss.ffffff") + " - " + System.Threading.Thread.CurrentThread.ManagedThreadId.ToString() + " : Robot.PushRequest\n");
            Task m = Task.Run(() => { RequestListEvent?.Invoke(this, new EventArgs(1, "Push")); });
            //RequestListEvent?.Invoke(this, new EventArgs(1, "Push"));
            File.AppendAllText("WriteLines.txt", DateTime.Now.ToString("HH:mm:ss.ffffff") + " - " + System.Threading.Thread.CurrentThread.ManagedThreadId.ToString() + " : Robot.PushRequest After Event Invoke \n" );
